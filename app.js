...
// paragrafo.innerHTML = 'Escolha um número entre 1 e 10'; isso aqui gera a mesma coisa que a função "exibirTextoNaTela"
...
function exibirTextoNaTela(tag, texto) {
    ...
    responsiveVoice.speak(texto, 'Breazilian Portuguese Female', {rate: 1.2})
}
